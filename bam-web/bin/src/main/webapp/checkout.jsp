	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="checkout.jsp" class="btn btn-danger">Régler ses achats</a>
			</div>
		</div>
	</div>
</div>
...
<div class="modal-dialog">
  ...
  <div class="modal-body">
    <div class="form">
                                      <form class="form-horizontal">
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-md-3">Déployer</label>
                                            <div class="col-md-9">                               
  ...
  <div class="modal-footer">
    <p>Vous avez déjà un compte? <a href="login.jsp">Cliquez</a> ici.</p>
  </div>
  </div>
  </div>
</div>
