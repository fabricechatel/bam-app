			...
			<div class="col-md-5 col-md-offset-3">
				...
				<form class="form-inline" role="form">
					<div class="form-group">
						<input type="email" class="form-control" id="search" placeholder="Rechercher">
					</div>
				...
				<div class="hlinks">
					<span>
					  ...
					  <a href="#cart" role="button" data-toggle="modal">3 articles dans votre
					  <i class="icon-shopping-cart"></i></a> -<span class="bold">$25</span>
					</span>

					<!-- Login and Register link -->
					<span class="lr">
					  <a href="#login" role="button"	data-toggle="modal">Login</a> /
					  <a href="#register" role="button"	data-toggle="modal">Enregistrement</a>
					</span>
				</div>
	...
	<div id="login" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
								...
								<div class="col-md-9 col-md-offset-3">
									<div class="checkbox inline">
										<label> <input type="checkbox" id="inlineCheckbox1"
											value="agree"> Se souvenir de moi
										</label>
									</div>
								</div>
							</div>
				...
				<div class="modal-footer">
					<p>
						Vous avez une compte? <a href="register.jsp">S'enregistrer</a> ici.
					</p>
				</div>
			</div>
		</div>
				...
				<div class="modal-body">
					<div class="form">
					  <form class="form-horizontal" id="registration">
						<div class="form-group">
							<label class="control-label col-md-3" for="civilite">Civilit�</label>
							<div class="col-md-9">
...
<!-- 						<div class="form-group">
							<label class="control-label col-md-3" for="mdp2">Confirmer mot de passe</label>
							<div class="col-md-9">
						...
						<div class="form-group">
							<div class="col-md-9 col-md-offset-3">
								<div class="checkbox inline">
									<label>
									  <input type="checkbox" id="inlineCheckbox2"	value="agree"> accepter les condition d'utilisation
									</label>
								</div>
							</div>  
						</div>
